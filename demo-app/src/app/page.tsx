  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        {/* Featured Demo - Intelligent Chat */}
        <div className="mb-6">
          <Link
            href="/smart-chat"
            className="group relative block bg-gradient-to-br from-purple-500/10 to-blue-500/10 border-2 border-purple-500/30 rounded-2xl p-8 hover:border-purple-500/50 transition-all hover:shadow-xl hover:shadow-purple-900/20"
          >
            <div className="flex items-center gap-2 mb-2">
              <span className="px-2 py-1 text-xs rounded bg-purple-500/20 text-purple-400 font-semibold">FEATURED</span>
              <span className="text-xs text-slate-400">Start Here</span>
            </div>
            <div className="flex items-start gap-6">
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center text-white flex-shrink-0">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-400 mb-4">
                  Watch AI automatically route each query to the optimal model. 8 factors analyzed in real-time:
                  data privacy, complexity, domain match, response time, cost, reasoning depth, context, and clarity.
                </p>
                <div className="flex flex-wrap gap-2">
                  {['8 Routing Factors', 'Real-time Analysis', 'Auto PII Protection', 'Weighted Scoring'].map((stat) => (
                    <span key={stat} className="px-3 py-1 text-sm rounded-full bg-purple-500/20 text-purple-300">
                      {stat}
                    </span>
                  ))}
                </div>
